                ...
                {({ isActive }) => (
                  <>
                    <span
                      ...
                      className={cn(
                        "animate-nav-float relative flex h-14 w-14 items-center justify-center rounded-2xl text-white shadow-lg transition-all duration-300 group-hover:scale-125 group-hover:shadow-[0_14px_30px_-8px_rgba(5,150,105,0.7)]",
                        item.gradient,
              ...
              <>
                <span
                  ...
                  className={cn(
                    ...
                    item.gradient,
                    isActive
                      ? "ring-2 ring-primary ring-offset-2 ring-offset-background shadow-[0_8px_20px_-6px_rgba(5,150,105,0.6)]"
                      : "opacity-90"
                  )}
                >
